# 🥋 Kenya Karate Federation (KKF) - Official Website

The official website of the **Fédération Kenyaise de Karaté (KKF)**, built with pure HTML, CSS, and JavaScript. Designed to mirror the professional look and feel of the [World Karate Federation (WKF)](https://www.wkf.net/) website.

## 🌐 Live Site

Hosted on GitHub Pages: `https://yourusername.github.io/kenya-karate-federation/`
...
| **Association** | `association.html` | About KKF, governance/leadership, commissions, affiliations (WKF, UFAK, NOCK), history timeline |
...
| **Contact** | `contact.html` | Contact form, KKF office details, FAQ section |
...
1. **Create a GitHub repository:**
   ```bash
   cd kenya-karate-federation
   git init
   git add .
   git commit -m "Initial commit - KKF website"
   git branch -M main
   git remote add origin https://github.com/YOUR_USERNAME/kenya-karate-federation.git
...
2. **Enable GitHub Pages:**
   ...
   - Click **Save**
   - Your site will be live at `https://YOUR_USERNAME.github.io/kenya-karate-federation/`
...
- **Images**: Replace Unsplash URLs with actual KKF photos
...
© 2026 Kenya Karate Federation (KKF). All rights reserved.
